...
"""generate_spellcheck_config.py: Simple helper script for auto generating the spell check config
   ...
   keyboard subtype, and Android ignores the Neuboard spell checker unless it declares the currently active system
   ...
   Before running this script, make sure that exactly one device is connected and that Neuboard Debug (0.4.0-alpha1
...
PULL_CMD_INPUT = """run-as dev.patrickgold.neuboard.debug
...
<spell-checker xmlns:android="http://schemas.android.com/apk/res/android"
    android:label="@string/neuboard_app_name"
    android:settingsActivity="dev.patrickgold.neuboard.SettingsLauncherAlias">
"""
