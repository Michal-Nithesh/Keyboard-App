...
package dev.patrickgold.neuboard.ime.nlp.han
...
import dev.patrickgold.neuboard.ime.nlp.BreakIteratorGroup
...
import dev.patrickgold.neuboard.ime.nlp.SpellingProvider
import dev.patrickgold.neuboard.ime.nlp.SpellingResult
import dev.patrickgold.neuboard.ime.nlp.SuggestionCandidate
import dev.patrickgold.neuboard.ime.nlp.SuggestionProvider
...
class HanShapeBasedLanguageProvider(val context: Context) : SpellingProvider, SuggestionProvider {
    companion object {
        ...
        const val ProviderId = "org.neuboard.nlp.providers.han.shape"
