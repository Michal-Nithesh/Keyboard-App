...
package dev.patrickgold.neuboard.ime.media.emoji
...
import dev.patrickgold.neuboard.ime.nlp.EmojiSuggestionCandidate
...
class EmojiSuggestionProvider(private val context: Context) : SuggestionProvider {
    override val providerId = "org.neuboard.nlp.providers.emoji"
