...
import dev.patrickgold.neuboard.ime.nlp.NlpInlineAutofillSuggestion
...
import org.neuboard.lib.snygg.SnyggPropertySet
...
fun InlineSuggestionsStyleCache() {
    val chipStyleSet = rememberSnyggThemeQuery(NeuboardImeUi.InlineAutofillChip.elementName)
