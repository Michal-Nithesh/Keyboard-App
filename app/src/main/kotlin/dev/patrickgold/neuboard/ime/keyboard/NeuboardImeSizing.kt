...
fun ProvideKeyboardRowBaseHeight(content: @Composable () -> Unit) {
    ...
    SideEffect {
        NeuboardImeSizing.Static.keyboardRowBaseHeightPx = baseRowHeight.toInt()
        NeuboardImeSizing.Static.smartbarHeightPx = smartbarHeight.toInt()
    }
