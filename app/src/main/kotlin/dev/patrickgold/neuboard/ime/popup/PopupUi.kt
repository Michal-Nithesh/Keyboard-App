...
fun PopupBaseBox(
    ...
    SnyggBox(
        elementName = NeuboardImeUi.KeyPopupBox.elementName,
        ...
        if (shouldIndicateExtendedPopups) {
            SnyggIcon(
                elementName = NeuboardImeUi.KeyPopupExtendedIndicator.elementName,
                attributes = attributes,
...
fun PopupExtBox(
    ...
    SnyggColumn(NeuboardImeUi.KeyPopupBox.elementName, attributes, modifier = modifier) {
        for (row in elements.asReversed()) {
            SnyggRow(
                ...
                for (element in row) {
                    ...
                    SnyggBox(
                        elementName = NeuboardImeUi.KeyPopupElement.elementName,
                        attributes = attributes,
                        selector = selector,
