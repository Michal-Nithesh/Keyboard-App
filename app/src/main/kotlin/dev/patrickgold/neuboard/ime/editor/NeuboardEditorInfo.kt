...
package dev.patrickgold.neuboard.ime.editor

import android.view.inputmethod.EditorInfo
import androidx.core.view.inputmethod.EditorInfoCompat
import androidx.emoji2.text.EmojiCompat

class NeuboardEditorInfo private constructor(val base: EditorInfo) {
    ...
    companion object {
        val Unspecified = NeuboardEditorInfo(EditorInfo())

        fun wrap(editorInfo: EditorInfo) = NeuboardEditorInfo(editorInfo)
    }
}
