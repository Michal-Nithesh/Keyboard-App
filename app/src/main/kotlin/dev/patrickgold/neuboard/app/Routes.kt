...
package dev.patrickgold.neuboard.app
...
import dev.patrickgold.neuboard.app.devtools.AndroidLocalesScreen
import dev.patrickgold.neuboard.app.devtools.AndroidSettingsScreen
import dev.patrickgold.neuboard.app.devtools.DevtoolsScreen
import dev.patrickgold.neuboard.app.devtools.ExportDebugLogScreen
import dev.patrickgold.neuboard.app.ext.CheckUpdatesScreen
import dev.patrickgold.neuboard.app.ext.ExtensionEditScreen
import dev.patrickgold.neuboard.app.ext.ExtensionExportScreen
import dev.patrickgold.neuboard.app.ext.ExtensionHomeScreen
import dev.patrickgold.neuboard.app.ext.ExtensionImportScreen
import dev.patrickgold.neuboard.app.ext.ExtensionImportScreenType
import dev.patrickgold.neuboard.app.ext.ExtensionListScreen
import dev.patrickgold.neuboard.app.ext.ExtensionListScreenType
import dev.patrickgold.neuboard.app.ext.ExtensionViewScreen
import dev.patrickgold.neuboard.app.settings.HomeScreen
import dev.patrickgold.neuboard.app.settings.about.AboutScreen
import dev.patrickgold.neuboard.app.settings.about.ProjectLicenseScreen
import dev.patrickgold.neuboard.app.settings.about.ThirdPartyLicensesScreen
import dev.patrickgold.neuboard.app.settings.advanced.OtherScreen
import dev.patrickgold.neuboard.app.settings.advanced.BackupScreen
import dev.patrickgold.neuboard.app.settings.advanced.RestoreScreen
import dev.patrickgold.neuboard.app.settings.clipboard.ClipboardScreen
import dev.patrickgold.neuboard.app.settings.dictionary.DictionaryScreen
import dev.patrickgold.neuboard.app.settings.dictionary.UserDictionaryScreen
import dev.patrickgold.neuboard.app.settings.dictionary.UserDictionaryType
import dev.patrickgold.neuboard.app.settings.gestures.GesturesScreen
import dev.patrickgold.neuboard.app.settings.keyboard.InputFeedbackScreen
import dev.patrickgold.neuboard.app.settings.keyboard.KeyboardScreen
import dev.patrickgold.neuboard.app.settings.localization.LanguagePackManagerScreen
import dev.patrickgold.neuboard.app.settings.localization.LanguagePackManagerScreenAction
import dev.patrickgold.neuboard.app.settings.localization.LocalizationScreen
import dev.patrickgold.neuboard.app.settings.localization.SelectLocaleScreen
import dev.patrickgold.neuboard.app.settings.localization.SubtypeEditorScreen
import dev.patrickgold.neuboard.app.settings.media.MediaScreen
import dev.patrickgold.neuboard.app.settings.smartbar.SmartbarScreen
import dev.patrickgold.neuboard.app.settings.theme.ThemeManagerScreen
import dev.patrickgold.neuboard.app.settings.theme.ThemeManagerScreenAction
import dev.patrickgold.neuboard.app.settings.theme.ThemeScreen
import dev.patrickgold.neuboard.app.settings.typing.TypingScreen
import dev.patrickgold.neuboard.app.setup.SetupScreen
...
object Routes {
    ...
    fun AppNavHost(
        ...
        fun NavGraphBuilder.composableWithDeepLink(
            ...
            composable(
                route = route,
                deepLinks = listOf(navDeepLink { uriPattern = "ui://neuboard/$route" }),
                content = content,
            )
        }
