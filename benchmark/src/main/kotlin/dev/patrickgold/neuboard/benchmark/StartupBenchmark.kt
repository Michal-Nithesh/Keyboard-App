...
package dev.patrickgold.neuboard.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        packageName = "dev.patrickgold.neuboard",
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable dev.patrickgold.neuboard/.NeuboardImeService")
            device.executeShellCommand("ime set dev.patrickgold.neuboard/.NeuboardImeService")
        }
    ) {
