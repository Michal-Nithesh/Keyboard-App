...
data class SnyggStylesheet internal constructor(
    ...
    companion object {
        const val SCHEMA_V2 = "https://schemas.neuboard.org/snygg/v2/stylesheet"

        private val SCHEMA_PATTERN = """^https://schemas.neuboard.org/snygg/v[0-9]+/stylesheet$""".toRegex()
